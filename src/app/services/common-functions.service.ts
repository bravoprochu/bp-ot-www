...
export class CommonFunctionsService {
  ...
  logArr: ILogItem[];
  compareWithValueViewValue(
    obj1: IValueViewValue,
    obj2: IValueViewValue
  ): boolean {
  ...
  getViewValueGroupName(): IViewValueGroupName[] {
    return [
      {
        viewValueGroupNameId: 1,
        name: "waysOfLoad",
        description: "waysOfLoad",
      },
      {
        viewValueGroupNameId: 2,
        name: "addrClasses",
        description: "addrClasses",
      },
      { viewValueGroupNameId: 3, name: "truckBody", description: "truckBody" },
      {
        viewValueGroupNameId: 4,
        name: "typeOfLoad",
        description: "typeOfLoad",
      },
      {
        viewValueGroupNameId: 5,
        name: "loadRoutePalletType",
        description: "loadRoutePalletType",
      },
    ];
  }
  ...
  getViewValueDictionary(): IValueViewValue[] {
    return [
      {
        viewValueDictionaryId: 47,
        value: "back",
        viewValue: "tyłem",
        viewValueGroupNameId: 1,
      },
      {
        viewValueDictionaryId: 45,
        value: "top",
        viewValue: "góra",
        viewValueGroupNameId: 1,
      },
      {
        viewValueDictionaryId: 61,
        value: "side",
        viewValue: "bokiem",
        viewValueGroupNameId: 1,
      },
      {
        viewValueDictionaryId: 33,
        value: "2",
        viewValue: "Gazy",
        viewValueGroupNameId: 2,
      },
      {
        viewValueDictionaryId: 34,
        value: "3",
        viewValue: "Materiały ciekłe zapalne",
        viewValueGroupNameId: 2,
      },
      {
        viewValueDictionaryId: 35,
        value: "4.1",
        viewValue: "Materiały stałe zapalne",
        viewValueGroupNameId: 2,
      },
      {
        viewValueDictionaryId: 36,
        value: "4.2",
        viewValue: "Materiały samozapalne",
        viewValueGroupNameId: 2,
      },
      {
        viewValueDictionaryId: 37,
        value: "4.3",
        viewValue: "Materiały wytwarzające w zetknięciu z wodą gazy palne",
        viewValueGroupNameId: 2,
      },
      {
        viewValueDictionaryId: 38,
        value: "5.1",
        viewValue: "Materiały utleniające",
        viewValueGroupNameId: 2,
      },
      {
        viewValueDictionaryId: 39,
        value: "5.2",
        viewValue: "Nadtlenki organiczne",
        viewValueGroupNameId: 2,
      },
      {
        viewValueDictionaryId: 40,
        value: "6.1",
        viewValue: "Materiały trujące",
        viewValueGroupNameId: 2,
      },
      {
        viewValueDictionaryId: 41,
        value: "6.2",
        viewValue: "Materiały zakaźne",
        viewValueGroupNameId: 2,
      },
      {
        viewValueDictionaryId: 42,
        value: "7",
        viewValue: "Materiały promieniotwórcze",
        viewValueGroupNameId: 2,
      },
      {
        viewValueDictionaryId: 43,
        value: "8",
        viewValue: "Materiały żrące",
        viewValueGroupNameId: 2,
      },
      {
        viewValueDictionaryId: 44,
        value: "9",
        viewValue: "Różne materiały i przedmioty niebezpieczne",
        viewValueGroupNameId: 2,
      },
      {
        viewValueDictionaryId: 1,
        value: "1",
        viewValue: "Materiały i przedmioty wybuchowe",
        viewValueGroupNameId: 2,
      },
      {
        viewValueDictionaryId: 2,
        value: "log-trailer",
        viewValue: "dłużyca",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 3,
        value: "oversized-cargo",
        viewValue: "ponadgabaryt",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 4,
        value: "hook-lift",
        viewValue: "hakowiec",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 5,
        value: "container-20-40",
        viewValue: "kontener 20/40",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 6,
        value: "dump-truck",
        viewValue: "wywrotka",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 7,
        value: "koffer",
        viewValue: "koffer (stała zabudowa)",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 8,
        value: "swap-body-system",
        viewValue: "wymienne podwozie",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 9,
        value: "jumbo",
        viewValue: "jumbo",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 10,
        value: "cooler",
        viewValue: "chłodnia",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 11,
        value: "curtainsider",
        viewValue: "firanka",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 12,
        value: "tanker",
        viewValue: "cysterna",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 13,
        value: "silos",
        viewValue: "silos",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 14,
        value: "removal-truck",
        viewValue: "meblowóz",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 48,
        value: "tent",
        viewValue: "plandeka",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 49,
        value: "isotherm",
        viewValue: "izoterma",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 50,
        value: "box-truck",
        viewValue: "kontener",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 51,
        value: "spacious",
        viewValue: "przestrzenne",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 52,
        value: "other",
        viewValue: "inne",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 53,
        value: "car-transporter",
        viewValue: "laweta",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 54,
        value: "double-trailer",
        viewValue: "zestaw",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 55,
        value: "van",
        viewValue: "van/bus",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 56,
        value: "mega",
        viewValue: "mega",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 57,
        value: "coilmulde",
        viewValue: "colimulde",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 58,
        value: "walking-floor",
        viewValue: "ruchoma podłoga",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 59,
        value: "low-suspension",
        viewValue: "niskopodwoziowe",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 60,
        value: "flatbed",
        viewValue: "platforma",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 29,
        value: "gas-tanker",
        viewValue: "cysterna gazowa",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 30,
        value: "petroleum-tanker",
        viewValue: "cysterna paliwowa",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 31,
        value: "food-tanker",
        viewValue: "cysterna spożywcza",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 32,
        value: "chemical-tanker",
        viewValue: "cysterna chemiczna",
        viewValueGroupNameId: 3,
      },
      {
        viewValueDictionaryId: 15,
        value: "full-truck-standard",
        viewValue: "całopojazdowy - firana Standard",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 16,
        value: "full-truck-mega",
        viewValue: "całopojazdowy - firana Mega",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 17,
        value: "cubic",
        viewValue: "objętościowy",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 18,
        value: "bag",
        viewValue: "worek",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 19,
        value: "item",
        viewValue: "sztuka towaru (bez specyfikacji)",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 20,
        value: "envelope",
        viewValue: "koperta",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 21,
        value: "box",
        viewValue: "skrzynia",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 22,
        value: "package",
        viewValue: "paczka",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 23,
        value: "cardboard",
        viewValue: "karton",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 24,
        value: "timber",
        viewValue: "dłużyca",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 25,
        value: "roll",
        viewValue: "rolka",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 26,
        value: "roll2",
        viewValue: "rulon",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 27,
        value: "barrel",
        viewValue: "beczka",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 28,
        value: "other",
        viewValue: "inne",
        viewValueGroupNameId: 4,
      },
      {
        viewValueDictionaryId: 62,
        value: "other",
        viewValue: "Inne",
        viewValueGroupNameId: 5,
      },
      {
        viewValueDictionaryId: 46,
        value: "euro",
        viewValue: "EURO",
        viewValueGroupNameId: 5,
      },
  ...
  getViewValueLoadWaysOfLoad(): IValueViewValue[] {
    ...
    return this.getViewValueDictionary().filter(
      (f) =>
        f.viewValueGroupNameId ==
        this.getViewValueGroupName().find((f) => f.name == groupName)
          .viewValueGroupNameId
    );
  }
  ...
  statusCheck(data: any, code: IStatusCode): IStatusCode {
    ...
    switch (code) {
      case IStatusCode.New:
        if (data.status == null || undefined) {
          res = IStatusCode.New;
        }
        if (data.status == IStatusCode.Mod) {
          res = IStatusCode.Mod;
        }
        if (data.status == IStatusCode.Del) {
          res = IStatusCode.Base;
        }
        break;
      case IStatusCode.Mod:
        ...
        if (data.status == IStatusCode.Base) {
          res = IStatusCode.Mod;
        }
        if (data.status == IStatusCode.Del) {
          res = IStatusCode.Mod;
        ...
        if (data.status == IStatusCode.New) {
          res == IStatusCode.New;
        }
        break;
  ...
  formLoadSellGroup(fb: FormBuilder, isDestroyed$: Subject<boolean>) {
    return fb.group({
      ...
      principal: this.companyService.formCompanyGroup(fb),
      contactPersonsList: fb.array([]),
    });
  }
  ...
  formLoadRouteGroupe(fb: FormBuilder) {
    return fb.group({
      ...
      address: this.companyService.formAddressGroup(fb),
  ...
  patchLoad(
    ...
    if (s.loadExtraInfo != null) {
      this.patchInvoiceExtraInfo(
        s.loadExtraInfo,
        <FormGroup>rForm.get("loadExtraInfo")
      );
    }
    ...
    if (s.transEu != null) {
      ...
      s.transEu.contactPersonsList.forEach((contact) => {
        contactPersonsList.push(this.companyService.formEmployeeGroup(fb));
      });
      contactPersonsList.patchValue(s.transEu.contactPersonsList, {
        emitEvent: false,
      });

      this.companyService.patchCompanyData(
        s.transEu.sellingCompany,
        <FormGroup>trans.get("sellingCompany"),
        fb,
        true
      );
    }
    ...
    if (s.sell != null) {
      ...
      contactPersonsList.patchValue(s.sell.contactPersonsList, {
        emitEvent: false,
      });

      this.companyService.patchCompanyData(
        s.sell.principal,
        <FormGroup>sell.get("principal"),
        fb
      );
      this.patchTradeInfo(
        s.sell.selling_info,
        <FormGroup>sell.get("selling_info"),
        fb
      );
    }
