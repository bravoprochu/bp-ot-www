...
export class InvoiceBuyComponent implements OnInit, OnDestroy, IDetailObj {
    ...
    if (id > 0) {
      this.df.getById(id)
        ...
        .subscribe((s: IInvoiceBuy) => {
          ...
          this.cf.patchInvoiceBuy(s, this.rForm, this.fb);
      ...
      //this.cf.patchInvoiceBuy(data, this.rForm, this.fb);
    }
  }
  ...
  initForm(): void {
    this.rForm = this.cf.formInvoiceBuyGroup(this.fb, this.isDestroyed$);
    this.currency.setValue(this.cf.getCurrencyByName("pln"));
